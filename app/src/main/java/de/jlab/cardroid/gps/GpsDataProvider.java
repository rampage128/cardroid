...
public final class GpsDataProvider extends DeviceDataProvider<GpsUsbDeviceHandler> {
    ...
    @Override
    public void onStart(@NonNull GpsUsbDeviceHandler device, @NonNull DeviceService service) {
    ...
    @Override
    protected void onUpdate(@NonNull GpsUsbDeviceHandler previousDevice, @NonNull GpsUsbDeviceHandler newDevice, @NonNull DeviceService service) {
        previousDevice.removePositionListener(this.positionListener);
        newDevice.addPositionListener(this.positionListener);
    }

    @Override
    public void onStop(@NonNull GpsUsbDeviceHandler device, @NonNull DeviceService service) {
        device.removePositionListener(this.positionListener);
