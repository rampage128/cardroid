...
public final class GpsPosition {
    ...
    public static final float MAX_DOP  = 50f;
    ...
    public void updateAccuracy(int fix, float pDop, float hDop, float vDop) {
        ...
        /* TODO Calculate a better accuracy, the current calculation is very inaccurate
         * Be warned. It seems accuracy calculation from Dop values is a strange mystery.
         */
